    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String name : names) {
            ...
            for (int level = first; level <= last; level++) {
                ...
                System.out.printf(java.util.Locale.ROOT, "{\"corpus\":\"%s\",\"level\":%d,\"originalSizeBytes\":%d,\"compressedSizeBytes\":%d,\"singleRunMs\":%.6f}%n", name, level, input.length, output.length, ms);
            }
        }
    }
}
