...
internal val DEFLATE_LEVELS = arrayOf(
    ...
    DeflateLevel(niceLength = 128, chainLength = 128, maxLazyLength = 16, maxHashBits = 18),
    DeflateLevel(niceLength = 128, chainLength = 256, maxLazyLength = 32, maxHashBits = 18),
    DeflateLevel(niceLength = 258, chainLength = 1_024, maxLazyLength = 128, maxHashBits = 18),
    DeflateLevel(
        niceLength = 258,
        chainLength = 4_096,
        maxLazyLength = 0,
