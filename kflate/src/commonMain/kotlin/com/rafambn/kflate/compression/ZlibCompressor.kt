...
internal fun compressZlib(data: ByteArray, type: ZlibCompression): ByteArray {
...
internal fun compressStreamZlib(type: ZlibCompression, source: RawSource, sink: RawSink) {
