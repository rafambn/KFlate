...
import { importObject, setWasmExports } from './kflate-demo.import-object.mjs'
...
const wasmFilePath = './kflate-demo.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./kflate-demo.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
